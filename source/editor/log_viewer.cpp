...
void LogViewer::Draw()
{
    ...
    ImGuiTableFlags table_flags = ImGuiTableFlags_RowBg | ImGuiTableFlags_Hideable | ImGuiTableFlags_Resizable | ImGuiTableFlags_ScrollY;
    
    if (!ImGui::BeginTable("LogsTable", 2, table_flags)) { ImGui::End(); ImGui::PopStyleVar(); return; }

    ImGui::TableSetupScrollFreeze(0, 1);
    ImGui::TableSetupColumn(ICON_TOOLTIP_QUESTION, ImGuiTableColumnFlags_WidthFixed | ImGuiTableColumnFlags_NoResize, ImGui::GetFontSize());
    ImGui::TableSetupColumn("Message", ImGuiTableColumnFlags_NoHide);
    ImGui::TableHeadersRow();
    
    ImGuiListClipper clipper;
    std::vector<Log::Log> logs = Systems::GetLogHandler()->GetLogs();
